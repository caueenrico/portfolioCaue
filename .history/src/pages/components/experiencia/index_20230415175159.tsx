...
export function Experiencias() {
  ...
  const [exp, setExp] = useState({
    ...
    descricao: <p>Atualmente como Técnico de Controle e Qualidade Operacional, fico responsável pelas operações marítimas no porto de santos, comunicação com a tripulação a bordo em inglês, cálculos de quantidades e análises físico químicas </p>,  });

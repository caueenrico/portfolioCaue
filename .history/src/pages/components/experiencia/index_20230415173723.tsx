    ...
    <Container>
      ...
      <DisplayExp>
        <ButtonsCont>
          ...
          <ButtonExp funcao={handlePutExp} active={active === 'Exército Brasileiro' ? 'active' : '' } name={"Exército Brasileiro"} />
          <ButtonExp funcao={handlePutExp} active={active === 'jovem Empreendedor' ? 'active' : '' } name={"jovem Empreendedor"} />
        </ButtonsCont>

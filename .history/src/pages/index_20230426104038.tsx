    ...
    <ContainerGeral id="home">
      ...
      <ContainerSobreMim id="sobre" >
        ...
        <SobreMim data-aos="fade-up">
          ...
          <LinkButtons>
            <a href={'/curriculo.pdf'} download={'meu curriculo'} className="gradienteAzul">
              <Download size={32} />
              Curriculo
            </a>

            <a href="https://wa.me/message/DALDHTPD7YKUD1" className="gradienteRosa">
      ...
      <ContainerProjetos id="projetos">
        ...
        <div className="projetos" data-aos='fade-up'>
          <Projeto img={dashGo} nomeDoProjeto="DashGo" descricao="projeto para dashboards" tecnologias="typescript, reactjs, tawild"/>
          <Projeto />
          <Projeto />
        </div>
      </ContainerProjetos>

  ...
  function handlePutExp(event: any) {
    ...
    if (nomedoButton === "Ultracargo") {
      ...
      setExp({
        ...
        descricao: (
          <p>
            Fui um dos alunos da escolas publicas selecionado para participar do
            programa jovem empreendedor do Governo do Estado de São Paulo, onde
            durante os finais de semamans ministrava atividades para os
            frequentadores da escola da familia, tive a oportunidade dar aula de reforço
            matemática basica, aulas de informatica, inglês Basico e atividades esportivas{" "}
          </p>
        ),
      });
    }

...
export function Experiencias() {
  const [active, setActive] = useState([true, 'Ultracargo'])
  ...
  return (
    <Container>
      ...
      <DisplayExp>
        <ButtonsCont>
          <ButtonExp funcao={handlePutExp} active={active === [true, 'Ultracargo'] ? 'active' : ''} name={"Ultracargo"} />
          <ButtonExp funcao={handlePutExp} active={active ? 'active' : ''} name={"Exército Brasileiro"} />
          <ButtonExp funcao={handlePutExp} active={active ? 'active' : ''} name={"jovem Empreendedor"} />
        </ButtonsCont>

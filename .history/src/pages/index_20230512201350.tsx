        ...
        <div className="projetos" data-aos="fade-up">
          ...
          <Projeto
            ...
            descricao="um protótipo de Dashboard para visualização de gráficos de
             um sistema específico. O projeto inclui a funcionalidade de adicionar usuários, formulários com validações e automação, oferecendo uma experiência completa e intuitiva para o usuárioo"

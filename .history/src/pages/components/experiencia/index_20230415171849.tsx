...
export function Experiencias() {
  ...
  function handlePutExp({event, active}: any) {
  ...
  return (
    <Container>
      ...
      <DisplayExp>
        <ButtonsCont>
          <ButtonExp funcao={handlePutExp(activr)}  name={"Ultracargo"} />
          <ButtonExp funcao={handlePutExp}  name={"Exército Brasileiro"} />
          <ButtonExp funcao={handlePutExp}  name={"jovem Empreendedor"} />
        </ButtonsCont>

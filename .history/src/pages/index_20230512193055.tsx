      ...
      <ContainerProjetos id="projetos">
        ...
        <div className="projetos" data-aos="fade-up">
          <Projeto
            ...
            descricao="Este é um site completo para uma loja especializada em cafés, com uma ampla variedade de opções disponíveis. Com uma aplicação completa, o site oferece uma experiência de compra online fácil e conveniente, com um catálogo completo que apresenta todas as opções de café disponíveis. Além disso, a plataforma oferece um carrinho de compras seguro e eficiente, onde é possível adicionar e remover itens antes de finalizar a compra. "
          ...
          <Projeto
            ...
            descricao="Um blog que se atualiza toda vez que subo uma nova issue dentro do meu github"
            tecnologias="ReactJS, StyleComponents, TypeScript"

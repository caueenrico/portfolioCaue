      ...
      <ContainerProjetos id="projetos">
        ...
        <div className="projetos" data-aos="fade-up">
          ...
          <Projeto
            ...
            descricao="Uma das aplicações mais legais que ja fiz, esse é um blog
            onde para que eu possa subir um post basta eu criar uma issue no meu próprio gitHub
            e essa aplicação ira consumir a api do github e automaticamente criara uma miniatura do post
            e uma pagina estilizada também, fora isso ela traz quantos comentarios teve dentro daquela issue
            data de postagem, e no prefil do usuario ja buscar sua descrição, numero de seguirdores. tem tem uma barra de pesquisa 
            onde o usuário pode buscar assuntos relacionados ao tema desejado
            "
            tecnologias="ReactJS, StyleComponents, TypeScript"

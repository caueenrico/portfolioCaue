      ...
      setExp({
        ...
        descricao: (
          <p>
            ...
            patriotismo. Passar neste concurso para mim foi uma grande vitória
            me formei aspirante a oficial temporário. Pude vivenciar na "pele" o trabalho
            em equipe, a força, o espirito de liderança, estratégia e patriotismo{" "}
          </p>
        ),
      });
      ...
      setExp({
        ...
        descricao: (
          <p>
            ...
            tive a oportunidade dar aula de reforço matemática basica, aulas de
            informatica, inglês Básico e atividades esportivas. Foi uma
            experiência incrivel para mim, pois com 16 anos tive a oportunidade
            de me desenvolver minha comunicação, responsabilidade e maturidade{" "}
          </p>
        ),
      });
    }

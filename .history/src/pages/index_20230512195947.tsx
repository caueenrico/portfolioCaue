      ...
      <ContainerProjetos id="projetos">
        ...
        <div className="projetos" data-aos="fade-up">
          ...
          <Projeto
            ...
            descricao="Uma das aplicações mais legais que ja fiz, um blog inovador que utiliza a API do GitHub para criar automaticamente miniaturas de postagens e páginas estilizadas a partir de issues criadas. A aplicação também exibe informações relevantes, como número de comentários e dados do usuário, como descrição e número de seguidores. Além disso, possui uma barra de pesquisa para buscar conteúdo relacionado. É um projeto desafiador e completo que demonstra habilidades avançadas de desenvolvimento de front-end.
            "
            tecnologias="ReactJS, StyleComponents, TypeScript"

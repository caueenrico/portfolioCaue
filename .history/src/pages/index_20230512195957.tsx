      ...
      <ContainerProjetos id="projetos">
        ...
        <div className="projetos" data-aos="fade-up">
          ...
          <Projeto
            ...
            também exibe informações relevantes, como número de comentários e dados do usuário, como descrição e número de seguidores. Além disso, possui uma barra de pesquisa para buscar conteúdo relacionado. É um projeto desafiador e completo que demonstra habilidades avançadas de desenvolvimento de front-end.
            "
            tecnologias="ReactJS, StyleComponents, TypeScript"

  ...
  function handlePutExp(event: any) {
    ...
    if (nomedoButton === "Ultracargo") {
      ...
      setExp({
        ...
        descricao: 
          <p>
            Fui aprovado no concurso para aluno oficial do exército brasileiro, me formei aspirante a oficial temporário. Pude vivenciar uma experiência incrível de trabalho em equipe, força, estratégia e patriotismo{" "}
          </p>
        ,
      });

      ...
      <ContainerProjetos id="projetos">
        ...
        <div className="projetos" data-aos="fade-up">
          ...
          <Projeto
            ...
            descricao="Um protótipo de DashBoard para visualização de gráficos de um determinado sistema,
            com possibilidade de adicionar usuários, formulários com Validações e automação"

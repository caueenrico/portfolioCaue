  ...
  function handlePutExp(event: any) {
    ...
    if (nomedoButton === "Ultracargo") {
      ...
      setExp({
        ...
        descricao: (
          <p>
            ...
            me formei aspirante a oficial temporário. Pude vivenciar uma
            experiência incrível de trabalho em equipe, força, estratégia e
            patriotismo{" "}
          </p>
        ),
      });
      ...
      setExp({
        ...
        descricao: (
          <p>
            Fui selecionado para participar do
            programa jovem empreendedor do Governo do Estado de São Paulo, onde
            durante os finais de semanas ministrava atividades para os
            frequentadores da escola da familia, tive a oportunidade dar aula de
            reforço matemática basica, aulas de informatica, inglês Básico e
            atividades esportivas. Foi uma experiência incrivel para mim, pois com 16 anos {" "}
          </p>
        ),
      });
    }

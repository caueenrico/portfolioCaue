  ...
  function handlePutExp(event: any) {
    ...
    if (nomedoButton === "Ultracargo") {
      ...
      setExp({
        ...
        descricao: (
          <p>
            Fui um dos alunos da escolas publicas selecionado para participar do programa jovem empreendedor do
            Governo do Estado de São Paulo, onde pude desenvolver uma{" "}
          </p>
        ),
      });
    }
